...
public class FormPageFactory
{
  ...
  protected final String TEXT_4 = "\" >" + NL + " <html:errors/>" + NL + "   <table>" + NL + "        <tr>" + NL + "          <td align=\"center\" colspan=\"2\">" + NL + " \t\t  <font size=\"4\">Please Enter the Following Details</font>" + NL + " \t\t</tr>" + NL + " <% for(int i=0; i< fp.getControls.length; i++) {" + NL + " " + NL + " \tCo" + NL + " \tif ()" + NL + " }" + NL + " %>" + NL + "\t" + NL + "}$>" + NL + "</body>" + NL + "</html>" + NL + "$";
